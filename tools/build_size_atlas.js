...
function svgFor(row) {
  ...
  <metadata>Creator: Stienhardt. License: CC BY 4.0. Source: ${publicRoot}size-atlas.html</metadata>
  <defs>
  ...
  <text x="72" y="584" fill="#091d2e" font-family="Georgia, serif" font-size="25">Facet by Stienhardt</text>
